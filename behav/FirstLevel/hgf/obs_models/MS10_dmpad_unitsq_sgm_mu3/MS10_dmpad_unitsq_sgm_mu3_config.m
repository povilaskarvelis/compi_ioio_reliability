function c = MS10_dmpad_unitsq_sgm_mu3_config
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
...
%
% f(MS10_dmpad_unitsq_sgm_mu3) = MS10_dmpad_unitsq_sgm_mu3^zeta/(MS10_dmpad_unitsq_sgm_mu3^zeta + (1-MS10_dmpad_unitsq_sgm_mu3)^zeta) = ustapas_sgm(MS10_dmpad_unitsq_sgm_mu3; zeta),
%
% where MS10_dmpad_unitsq_sgm_mu3 is in the unit interval, and zeta > 0 is a parameter that determines the shape of the
...
%
% This file is part of the HGF toolboMS10_dmpad_unitsq_sgm_mu3, which is released under the terms of the GNU General Public
...
% Model name
c.model = 'MS10_dmpad_unitsq_sgm_mu3';
...
% Model filehandle
c.obs_fun = @MS10_dmpad_unitsq_sgm_mu3;

% Handle to function that transforms observation parameters to their native space
% from the space they are estimated in
c.transp_obs_fun = @MS10_dmpad_unitsq_sgm_mu3_transp;
