function c = MS11_dmpad_unitsq_sgm_mu3_config
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
...
%
% f(MS11_dmpad_unitsq_sgm_mu3) = MS11_dmpad_unitsq_sgm_mu3^zeta/(MS11_dmpad_unitsq_sgm_mu3^zeta + (1-MS11_dmpad_unitsq_sgm_mu3)^zeta) = ustapas_sgm(MS11_dmpad_unitsq_sgm_mu3; zeta),
%
% where MS11_dmpad_unitsq_sgm_mu3 is in the unit interval, and zeta > 0 is a parameter that determines the shape of the
...
% Model name
c.model = 'MS11_dmpad_unitsq_sgm_mu3';
...
% Model filehandle
c.obs_fun = @MS11_dmpad_unitsq_sgm_mu3;

% Handle to function that transforms observation parameters to their native space
% from the space they are estimated in
c.transp_obs_fun = @MS11_dmpad_unitsq_sgm_mu3_transp;
