function c = MS14_dmpad_constant_voltemp_exp_config(ptrans)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
...
% Model name
c.model = 'MS14_dmpad_constant_voltemp_exp';
...
% Model filehandle
c.obs_fun = @MS14_dmpad_constant_voltemp_exp;

% Handle to function that transforms observation parameters to their native space
% from the space they are estimated in
c.transp_obs_fun = @MS14_dmpad_constant_voltemp_exp_transp;
