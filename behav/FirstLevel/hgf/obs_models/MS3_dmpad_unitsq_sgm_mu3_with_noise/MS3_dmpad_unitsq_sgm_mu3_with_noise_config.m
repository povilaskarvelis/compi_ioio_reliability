function c = MS3_dmpad_unitsq_sgm_mu3_with_noise_config
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
...
% Model name
c.model = 'MS3_dmpad_unitsq_sgm_mu3_with_noise';
...
% Model filehandle
c.obs_fun = @MS3_dmpad_unitsq_sgm_mu3_with_noise;

% Handle to function that transforms observation parameters to their native space
% from the space they are estimated in
c.transp_obs_fun = @MS3_dmpad_unitsq_sgm_mu3_with_noise_transp;
