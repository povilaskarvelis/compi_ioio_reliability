function c = MS5_dmpad_unitsq_sgm_mu3_config
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
...
%
% f(MS5_dmpad_unitsq_sgm_mu3) = MS5_dmpad_unitsq_sgm_mu3^zeta/(MS5_dmpad_unitsq_sgm_mu3^zeta + (1-MS5_dmpad_unitsq_sgm_mu3)^zeta) = ustapas_sgm(MS5_dmpad_unitsq_sgm_mu3; zeta),
%
% where MS5_dmpad_unitsq_sgm_mu3 is in the unit interval, and zeta > 0 is a parameter that determines the shape of the
...
%
% This file is part of the HGF toolboMS5_dmpad_unitsq_sgm_mu3, which is released under the terms of the GNU General Public
...
% Model name
c.model = 'MS5_dmpad_unitsq_sgm_mu3';
...
% Model filehandle
c.obs_fun = @MS5_dmpad_unitsq_sgm_mu3;

% Handle to function that transforms observation parameters to their native space
% from the space they are estimated in
c.transp_obs_fun = @MS5_dmpad_unitsq_sgm_mu3_transp;
