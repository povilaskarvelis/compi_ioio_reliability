function c = MS10_dmpad_ehgf_BO_lt136_config
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
...
% Model name
c.model = 'MS10_dmpad_ehgf_BO_lt136';
...
c.prc_fun = @MS10_dmpad_ehgf_BO_lt136;

% Handle to function that transforms perceptual parameters to their native space
% from the space they are estimated in
c.transp_prc_fun = @MS10_dmpad_ehgf_BO_lt136_transp;
