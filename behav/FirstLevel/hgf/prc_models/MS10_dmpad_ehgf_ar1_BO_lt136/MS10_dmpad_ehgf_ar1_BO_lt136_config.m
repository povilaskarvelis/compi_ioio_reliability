function c = MS10_dmpad_ehgf_ar1_BO_lt136_config
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
...
% Model name
c.model = 'MS10_dmpad_ehgf_ar1_BO_lt136';
...
% Undefined (therefore NaN) at the first level.
c.mmu = [NaN, c.mu_0mu(2), 1.1155]; % [NaN, c.mu_0mu(2), c.mu_0mu(3)];
c.msa = [NaN, 0,           0];
...
c.prc_fun = @MS10_dmpad_ehgf_ar1_BO_lt136;

% Handle to function that transforms perceptual parameters to their native space
% from the space they are estimated in
c.transp_prc_fun = @MS10_dmpad_ehgf_ar1_BO_lt136_transp;
