function c = MS14_dmpad_hgf_config
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
...
c.logsa_0mu = [NaN, log(1), log(1)]; % orig: log(0.1), log(1)
c.logsa_0sa = [NaN,      0,      0];
...
c.prc_fun = @MS14_dmpad_hgf;

% Handle to function that transforms perceptual parameters to their native space
% from the space they are estimated in
c.transp_prc_fun = @MS14_dmpad_hgf_transp;
