function c = MS14_dmpad_hgf_ar1_lvl3_BO_lt136_config
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
...
% Model name
c.model = 'MS14_dmpad_hgf_ar1_lvl3_BO_lt136';
...
% Undefined (therefore NaN) at the first level.
c.logitkamu = [NaN, tapas_logit(0.4846,c.kaub(2))];
c.logitkasa = [NaN, 0];
...
% Theta
% Format: scalar
c.logitthmu = tapas_logit(0.5000,c.thub);
c.logitthsa = 0;
...
c.prc_fun = @MS14_dmpad_hgf_ar1_lvl3_BO_lt136;

% Handle to function that transforms perceptual parameters to their native space
% from the space they are estimated in
c.transp_prc_fun = @MS14_dmpad_hgf_ar1_lvl3_BO_lt136_transp;
