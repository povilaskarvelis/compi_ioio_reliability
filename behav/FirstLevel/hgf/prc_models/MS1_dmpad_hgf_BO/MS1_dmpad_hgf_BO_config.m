function c = MS1_dmpad_hgf_BO_config
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
...
% is centered at 0.
c.mu_0mu = [NaN, 0.3934, 0.9767];
c.mu_0sa = [NaN, 0, 0];

c.logsa_0mu = [NaN, log(0.8167), log(3.9804)];
c.logsa_0sa = [NaN,          0,      0];
...
c.logitkamu = [NaN, tapas_logit(0.4672,c.kaub(2))];
c.logitkasa = [NaN, 0];
...
% Theta
% Format: scalar
c.logitthmu = tapas_logit(0.4869,c.thub);
c.logitthsa = 0;
...
c.prc_fun = @MS1_dmpad_hgf_BO;

% Handle to function that transforms perceptual parameters to their native space
% from the space they are estimated in
c.transp_prc_fun = @MS1_dmpad_hgf_BO_transp;
