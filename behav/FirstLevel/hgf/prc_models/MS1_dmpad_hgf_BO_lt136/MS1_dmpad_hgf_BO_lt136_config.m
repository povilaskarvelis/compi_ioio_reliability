function c = MS1_dmpad_hgf_BO_lt136_config
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
...
% Model name
c.model = 'MS1_dmpad_hgf_BO_lt136';
...
% is centered at 0.
c.mu_0mu = [NaN, 0.4000, 0.9765];
c.mu_0sa = [NaN, 0, 0];

c.logsa_0mu = [NaN, log(0.8240), log(4)];
c.logsa_0sa = [NaN,          0,      0];
...
c.logitkamu = [NaN, tapas_logit(0.4601,c.kaub(2))];
c.logitkasa = [NaN, 0];
...
% Theta
% Format: scalar
c.logitthmu = tapas_logit(0.4833,c.thub);
c.logitthsa = 0;
...
c.prc_fun = @MS1_dmpad_hgf_BO_lt136;

% Handle to function that transforms perceptual parameters to their native space
% from the space they are estimated in
c.transp_prc_fun = @MS1_dmpad_hgf_BO_lt136_transp;
