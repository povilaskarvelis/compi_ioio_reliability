function c = MS1_dmpad_hgf_ar1_lvl3_BO_config
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
...
% Model name
c.model = 'MS1_dmpad_hgf_ar1_lvl3_BO';
...
c.mu_0mu = [NaN, 0.5449, 0.9529];
c.mu_0sa = [NaN, 0, 0];

c.logsa_0mu = [NaN, log(0.8250), log(1.0001)];
c.logsa_0sa = [NaN,    0,        0];
...
% Undefined (therefore NaN) at the first level.
c.logitkamu = [NaN, tapas_logit(0.4720,c.kaub(2))];
c.logitkasa = [NaN, 0];
...
% Theta
% Format: scalar
c.logitthmu = tapas_logit(0.4994,c.thub);
c.logitthsa = 0;
...
c.prc_fun = @MS1_dmpad_hgf_ar1_lvl3_BO;

% Handle to function that transforms perceptual parameters to their native space
% from the space they are estimated in
c.transp_prc_fun = @MS1_dmpad_hgf_ar1_lvl3_BO_transp;
