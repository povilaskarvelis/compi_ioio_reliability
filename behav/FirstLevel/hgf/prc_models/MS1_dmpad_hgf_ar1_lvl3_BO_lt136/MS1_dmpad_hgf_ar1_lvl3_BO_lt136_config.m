function c = MS1_dmpad_hgf_ar1_lvl3_BO_lt136_config
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
...
% Model name
c.model = 'MS1_dmpad_hgf_ar1_lvl3_BO_lt136';
...
c.mu_0mu = [NaN, 0.3947, 0.8666];
c.mu_0sa = [NaN, 0, 0];

c.logsa_0mu = [NaN, log(0.8175), log(1)];
c.logsa_0sa = [NaN,    0,        0];
...
% Undefined (therefore NaN) at the first level.
c.logitkamu = [NaN, tapas_logit(0.4657,c.kaub(2))];
c.logitkasa = [NaN, 0];
...
% Theta
% Format: scalar
c.logitthmu = tapas_logit(0.4850,c.thub);
c.logitthsa = 0;
...
c.prc_fun = @MS1_dmpad_hgf_ar1_lvl3_BO_lt136;

% Handle to function that transforms perceptual parameters to their native space
% from the space they are estimated in
c.transp_prc_fun = @MS1_dmpad_hgf_ar1_lvl3_BO_lt136_transp;
