function c = MS2_dmpad_hgf_v3_config
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
...
c.logsa_0mu = [NaN, log(1), log(4)]; % orig: log(0.1), log(1)
c.logsa_0sa = [NaN,      1,      0];
...
c.prc_fun = @MS2_dmpad_hgf_v3;

% Handle to function that transforms perceptual parameters to their native space
% from the space they are estimated in
c.transp_prc_fun = @MS2_dmpad_hgf_v3_transp;
