function c = MS2_dmpad_hgf_v3_ar1_lvl3_config
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
...
% Model name
c.model = 'MS2_dmpad_hgf_v3_ar1_lvl3';
...
c.prc_fun = @MS2_dmpad_hgf_v3_ar1_lvl3;

% Handle to function that transforms perceptual parameters to their native space
% from the space they are estimated in
c.transp_prc_fun = @MS2_dmpad_hgf_v3_ar1_lvl3_transp;
