function [traj, infStates] = MS4_dmpad_hgf_ar1_lvl3(r, p, varargin)
% Calculates the trajectories of the agent's representations under the HGF for AR(1) processes
% and binary outcomes.
%
% This function can be called in two ways:
% 
% (1) MS4_dmpad_hgf_ar1_lvl3(r, p)
%   
%     where r is the structure generated by tapas_fitModel and p is the parameter vector in native space;
%
% (2) MS4_dmpad_hgf_ar1_lvl3(r, ptrans, 'trans')
% 
...
if ~isempty(varargin) && strcmp(varargin{1},'trans');
    p = MS4_dmpad_hgf_ar1_lvl3_transp(r, p);
end
