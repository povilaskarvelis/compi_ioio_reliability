function c = MS4_dmpad_hgf_ar1_lvl3_config
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
...
% Model name
c.model = 'MS4_dmpad_hgf_ar1_lvl3';
...
c.prc_fun = @MS4_dmpad_hgf_ar1_lvl3;

% Handle to function that transforms perceptual parameters to their native space
% from the space they are estimated in
c.transp_prc_fun = @MS4_dmpad_hgf_ar1_lvl3_transp;
