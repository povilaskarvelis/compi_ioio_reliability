function c = MS6_dmpad_ehgf_mu30_sa30_free_config
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
...
% Model name
c.model = 'MS6_dmpad_ehgf_mu30_sa30_free';
...
c.prc_fun = @MS6_dmpad_ehgf_mu30_sa30_free;

% Handle to function that transforms perceptual parameters to their native space
% from the space they are estimated in
c.transp_prc_fun = @MS6_dmpad_ehgf_mu30_sa30_free_transp;
