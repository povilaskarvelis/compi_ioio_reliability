function c = MS9_dmpad_hgf_ar1_lvl3_BO_lt136_config
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
...
% Model name
c.model = 'MS9_dmpad_hgf_ar1_lvl3_BO_lt136';
...
c.prc_fun = @MS9_dmpad_hgf_ar1_lvl3_BO_lt136;

% Handle to function that transforms perceptual parameters to their native space
% from the space they are estimated in
c.transp_prc_fun = @MS9_dmpad_hgf_ar1_lvl3_BO_lt136_transp;
