function c = MS9_dmpad_hgf_ar1_lvl3_BO_lt170_config
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
...
% Model name
c.model = 'MS9_dmpad_hgf_ar1_lvl3_BO_lt170';
...
% Undefined (therefore NaN) at the first level.
c.logitkamu = [NaN, tapas_logit(0.4692,c.kaub(2))];
c.logitkasa = [NaN, 0];
...
c.prc_fun = @MS9_dmpad_hgf_ar1_lvl3_BO_lt170;

% Handle to function that transforms perceptual parameters to their native space
% from the space they are estimated in
c.transp_prc_fun = @MS9_dmpad_hgf_ar1_lvl3_BO_lt170_transp;
