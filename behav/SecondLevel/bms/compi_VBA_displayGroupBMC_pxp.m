function handles = compi_VBA_displayGroupBMC(posterior,out)
...
if doFig
    ...
    VBA_title(handles.ha(1),'Log-Model Evidences (LME)')
...
cla(handles.ha(4))
bar(handles.ha(4),out.pxp,'facecolor',0.8*[1 1 1])
