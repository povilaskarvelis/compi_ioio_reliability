function [posterior,out] = compi_VBA_groupBMC(L,options)
...
if options.DisplayWin
    ...
    options.handles = compi_VBA_displayGroupBMC_pxp(posterior,out);
    drawnow
end
...
if options.DisplayWin
    compi_VBA_displayGroupBMC_pxp(posterior,out);
end
